          ...
          >
            <Flex direction="col" className="gap-1 tablet:gap-2">
              ...
              <Text className="tablet:text-[16px] laptop:text-[18px]">
                ...
                audience. Scientists are trained to distrust unvalidated
                results, and AI is about as unvalidated as it gets. The most
                important design work wasn&apos;t making Plato powerful, it was
                making it feel safe enough to try. Every structural decision was
                ultimately about lowering the cost of a first interaction with
                AI.
              </Text>
            </Flex>
          </Callout>
          ...
          >
            <Flex direction="col" className="gap-1 tablet:gap-2">
              ...
              <Text className="tablet:text-[16px] laptop:text-[18px]">
                ...
                impressive,&quot; it was &quot;this feels like what I was
                already doing.&quot; That reaction didn&apos;t happen by
                accident. When introducing AI to skeptical users, the goal
                isn&apos;t to showcase what the technology can do. It&apos;s to
                make the technology disappear into a workflow people already
                trust.
              </Text>
            </Flex>
          </Callout>
          ...
          >
            <Flex direction="col" className="gap-1 tablet:gap-2">
              ...
              <Text className="tablet:text-[16px] laptop:text-[18px]">
                ...
                had already been built. This is increasingly common in AI
                product design: the model is ready before the experience is, and
                designers are left bridging a gap between raw capability and
                human comfort.
              </Text>
            </Flex>
          </Callout>
          ...
          >
            <Flex direction="col" className="gap-1 tablet:gap-2">
              ...
              <Text className="tablet:text-[16px] laptop:text-[18px]">
                ...
                their first real moment of trust (or distrust). Designing for
                that means building reassurance into the experience at every
                step, not just at the beginning.
              </Text>
            </Flex>
          </Callout>
        </Flex>
      ...
      <Flex direction="col" className="gap-3 tablet:gap-4 laptop:gap-6">
          ...
          >
            <Flex direction="col" className="gap-1 tablet:gap-2">
              ...
              <Text className="tablet:text-[16px] laptop:text-[18px]">
                ...
                academia, accessibility standards will become non-negotiable.
                Many scientists also work on tablets at the bench. The current
                designs were optimized for desktop and would need to be
                revisited for smaller viewports.
              </Text>
            </Flex>
          </Callout>
        </Flex>
        ...
        >
          <Flex direction="col" className="gap-1 tablet:gap-2">
            ...
            <Text className="tablet:text-[16px] laptop:text-[18px]">
              As Plato handles more complex workflows, how do we continue to
              show users what the AI is doing and why, without adding cognitive
              overhead? The current MVP kept this simple by design. At scale,
              that balance becomes much harder to maintain.
            </Text>
          </Flex>
        </Callout>
      </Flex>
